...
@controller(`${config.apiPrefix}/cor`)
export class CorController extends BaseHttpController implements interfaces.Controller {
  constructor(
    @inject(TYPES.ICorService) private readonly corService: ICorService
  ) {
    super();
  }
